...
const Contact = () => {
  ...
  return (
    <div className='w-full h-full'>
      <h3 className='text-center my-10 text-4xl font-serif'>Contact <span className='text-blue-300'>Now</span></h3>

      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d233356.88719723377!2d90.23976005632824!3d23.953318674809573!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c62fb95f16c1%3A0xb333248370356dee!2sJamuna%20Future%20Park!5e0!3m2!1sen!2sbd!4v1704031546940!5m2!1sen!2sbd" width="100%" style={{border:0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className='mb-10 md:mb-16 md:h-[15rem] lg:h-[23rem]'></iframe>
